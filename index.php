...
<?php get_header(); ?>
	...
	<div id="fh5co-project">
        ...
        <div id="joinus" class="fh5co-cover" style="background-image: url(<?php bloginfo('template_url'); ?>/images/bxjg.jpg);background-position: bottom;"  data-stellar-background-ratio="0.5" >
            <div class="overlay"></div>
            <div class="container">
                <div class="row">
                    <div class="center-block text-center">
                ...
                <div class="row animate-box" data-animate-effect="fadeInUp" >
                    <div class="col-md-8 col-md-offset-2 text-left fh5co-heading">
                        ...
                        <p>
                            ...
                            三维产品动画——我们绝不按照常规套路模版式的简单的去介绍您的产品，而是先去深入了解您的产品，如果有必要，甚至源代码！甚至源图纸！然后从各个方面去寻找您产品的最佳最酷最新的表现方式，哪怕，用表现兰博基尼的方式去表现一个鱼缸！（我们又不是没干过...）
